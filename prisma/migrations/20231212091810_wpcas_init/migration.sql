...
CREATE TABLE "Level" (
    ...
    CONSTRAINT "Level_pkey" PRIMARY KEY ("levelNumber")
);
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_levelNumber_fkey" FOREIGN KEY ("levelNumber") REFERENCES "Level"("levelNumber") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "competency_levels" ADD CONSTRAINT "competency_levels_levelNumber_fkey" FOREIGN KEY ("levelNumber") REFERENCES "Level"("levelNumber") ON DELETE RESTRICT ON UPDATE CASCADE;
