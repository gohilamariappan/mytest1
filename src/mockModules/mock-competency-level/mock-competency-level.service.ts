...
export class MockCompetencyLevelService {
    ...
    public async createCompetencyLevel(createCompetencyLevelDto: CreateCompetencyLevelDto) {
      ...
      public async findCompetencyLevelById(id: number) {
        ...
        if (!competencyLevel) throw new NotFoundException(`CompetencyLevel with id #${id} not found`);
